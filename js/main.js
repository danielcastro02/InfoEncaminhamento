...
var FullCalendar = (function (exports) {
        ...
        ToolbarSection.prototype.renderWidgetGroup = function (widgetGroup) {
            ...
            for (var _i = 0, widgetGroup_1 = widgetGroup; _i < widgetGroup_1.length; _i++) {
                ...
                if (buttonName === 'title') {
                    ...
                    var buttonClasses = ['fc-' + buttonName + '-button', theme.getClass('button'), 'waves-effect'];
                    ...
                    children.push(createElement("button", __assign({className: buttonClasses.join(' '), onClick: buttonClick, type: 'button' }, ariaAttrs), buttonText || (buttonIcon ? createElement("span", { className: buttonIcon }) : '')));
                }
            }
    ...
    */
    ...
    // certain clipping containers should never constrain interactions, like <html lang="pt-br"> and <body>

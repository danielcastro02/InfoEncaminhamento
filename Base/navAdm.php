...
<ul id="slide-out" class="sidenav sidenav-fixed">
    ...
    <li class="no-padding">
        <ul class="collapsible">
            ...
            <li class="destaque">
                <a class="destaqueLinha waves-effect black-text collapsible-header anime" x="0"
                   href="<?php echo $pontos . 'Tela/listagemUsuario.php' ?>">
                    <i class="material-icons changeColor" style="color: black; font-size: 1.5rem">people</i>
                    Usuários
                </a>
            </li>
            <li class="destaque">
                <a class="destaqueLinha waves-effect black-text collapsible-header anime" x="0"
                   href="<?php echo $pontos ?>/Tela/configuracoes.php">
                    <i class="material-icons changeColor" style="color: black; font-size: 1.5rem">settings</i>
                    Configurações
                </a>
            </li>
            ...
            if ($logado->getAdministrador() > 1) {
                ...
                <li class="destaque">
                    <a class="destaqueLinha waves-effect black-text collapsible-header anime" x="0" href="#!">
                        <i class="material-icons changeColor"
                           style="color: black; font-size: 1.5rem">settings</i>
                        God Mode
                    ...
                    <div class="collapsible-body bodyColorCollapsible">
                        <ul>
                            <li>
                                <a href="<?php echo $pontos . 'Tela/chamadosAtivos.php' ?>">
                            ...
                            <li>
                                <a href="<?php echo $pontos; ?>Tela/configuracoesAvancadas.php">
                                    <i class="material-icons icons-internos">arrow_right</i>
                                    Configurações
                                </a>
                            </li>

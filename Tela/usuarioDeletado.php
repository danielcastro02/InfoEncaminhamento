                    ...
                    <div class="row">
                        ...
                        <form method="POST" action="../Controle/emailControle.php?function=usuarioDeletado">
                            <div class="input-field col s12">
                                <input autocomplete="off" type="text" name="id_usuario" hidden="true" value="<?php echo $_GET['id_usuario']; ?>"/>
                                <input autocomplete="off" id="remetente" type="text" name='remetente' required="true"/>
